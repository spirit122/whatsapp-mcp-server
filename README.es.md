...
> **35 herramientas** | **8 modulos** | **Hospedado en Cloudflare Workers** | **Sin instalar nada**
...
### Paso 3: Conectar a Claude

Agrega esto a tu archivo de configuracion MCP de Claude:
